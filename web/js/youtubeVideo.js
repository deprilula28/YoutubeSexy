...
YoutubeSexy.prototype.playVideo = function(videoResult, posterResult, mouseX, mouseY, thumbnail){
  ...
  $("#bigVideoIFrame").src = "https://www.youtube.com/embed/" + this.playing + "?autoplay=1&enablejsapi=1&theme=light&showinfo=0";
  ...
  //Comments
  this.loadCommentSection(this.playing, videoResult.statistics.commentCount);
...
YoutubeSexy.prototype.loadCommentSection = function(videoId, commentCount){

	$("#commentAmountTitle").get(0).textContent = "Amount of comments: " + commentCount;
	...
	youtubeSexy.ytDataAPI.googleAPIGet("https://www.googleapis.com/youtube/v3/commentThreads", {
		...
		for(var itemIndex in result.items){
			...
			this.appendCommentHTML(item.snippet.topLevelComment.snippet.textDisplay, contentColumn);
		}
	});
